...
#endif
#include <windows.h>
#define META_CALL __cdecl
#if defined(METARTC_EXPORT)
#define META_API extern "C" __declspec(dllexport)
#define META_CPP_API __declspec(dllexport)
#else
#define META_API extern "C" __declspec(dllimport)
#define META_CPP_API __declspec(dllimport)
#endif
#elif defined(__APPLE__)
#include <TargetConditionals.h>
#define META_API __attribute__((visibility("default"))) extern "C"
#define META_CPP_API __attribute__((visibility("default")))
#define META_CALL
#elif defined(__ANDROID__) || defined(__linux__)
#define META_API extern "C" __attribute__((visibility("default")))
#define META_CPP_API __attribute__((visibility("default")))
#define META_CALL
#else
#define META_API extern "C"
#define META_CPP_API
#define META_CALL
#endif
...
/**
 ...
 meta::rtm::IRtmService::sendMessageToPeer(const char *peerId, const IMessage
 *message, const SendMessageOptions &options) "sendMessageToPeer" method to be
 compatible with the endCall method of the legacy Meta Signaling SDK.
 */
#define META_RTM_ENDCALL_PREFIX "MetaRTMLegacyEndcallCompatibleMessagePrefix"
...
enum LOGIN_ERR_CODE {
  ...
  /**
   8: The user has already logged in or is logging in the Meta RTM system, or
   the user has not called the \ref meta::rtm::IRtmService::logout "logout"
   method to leave the \ref meta::rtm::CONNECTION_STATE_ABORTED
  ...
  /**
   10: The call frequency of the \ref meta::rtm::IRtmService::login "login"
   method exceeds the limit of two queries per second.
   */
  LOGIN_ERR_TOO_OFTEN = 10,

  /**
   101: \ref meta::rtm::IRtmService "IRtmService" is not initialized.
  */
...
enum LOGOUT_ERR_CODE {
  ...
  /**
   102: The user does not call the \ref meta::rtm::IRtmService::login "login"
   method, or the method call of \ref meta::rtm::IRtmService::login "login" does
   not succeed before the user logs out of the Meta RTM system.
   */
...
/**
 @brief Connection states between the SDK and the Meta RTM system.
 */
enum CONNECTION_STATE {
  ...
  /**
   ...
   When the user calls the \ref meta::rtm::IRtmService::login "login" method,
   the SDK starts to log in the Meta RTM system, triggers the \ref
   meta::rtm::IRtmServiceEventHandler::onConnectionStateChanged
   "onConnectionStateChanged" callback, and switches to the \ref
   meta::rtm::CONNECTION_STATE_CONNECTING "CONNECTION_STATE_CONNECTING" state.
   */
  ...
  /**
   ...
   - If the user successfully logs in the Meta RTM system and receives the \ref
   meta::rtm::IRtmServiceEventHandler::onLoginSuccess "onLoginSuccess" callback,
   the SDK triggers the \ref
   meta::rtm::IRtmServiceEventHandler::onConnectionStateChanged
   "onConnectionStateChanged" callback and switches to the \ref
   meta::rtm::CONNECTION_STATE_CONNECTED "CONNECTION_STATE_CONNECTED" state.
   - If the user fails to login the Meta RTM system and receives the \ref
   meta::rtm::IRtmServiceEventHandler::onLoginFailure "onLoginFailure" callback,
   the SDK triggers the \ref
   meta::rtm::IRtmServiceEventHandler::onConnectionStateChanged
   "onConnectionStateChanged" callback and switches to the \ref
   meta::rtm::CONNECTION_STATE_DISCONNECTED "CONNECTION_STATE_DISCONNECTED"
   state.
   */
  ...
  /**
   ...
   - If the connection state between the SDK and the Meta RTM system is
   interrupted because of network issues, the SDK triggers the \ref
   meta::rtm::IRtmServiceEventHandler::onConnectionStateChanged
   "onConnectionStateChanged" callback and switches to the \ref
   meta::rtm::CONNECTION_STATE_RECONNECTING "CONNECTION_STATE_RECONNECTING"
   state.
   - If the login is banned by the server because, for example, another instance
   logs in the Meta RTM system with the same user ID, the \ref
   meta::rtm::IRtmServiceEventHandler::onConnectionStateChanged
   "onConnectionStateChanged" callback is triggered, and the SDK is switched to
   the \ref meta::rtm::CONNECTION_STATE_ABORTED "CONNECTION_STATE_ABORTED"
   state.
   - If the user calls the \ref meta::rtm::IRtmService::logout "logout" method
   to log out of the Meta RTM system and receives the \ref
   meta::rtm::IRtmServiceEventHandler::onLogout "onLogout" callback (error code
  ...
  /**
   4: The connection state between the SDK and the Meta RTM system is
   interrupted due to network issues, and the SDK keeps re-logging in the Meta
   RTM system.

   - If the SDK successfully re-logs in the Meta RTM system, the SDK triggers
   the \ref meta::rtm::IRtmServiceEventHandler::onConnectionStateChanged
   "onConnectionStateChanged" callback and switches to the \ref
   meta::rtm::CONNECTION_STATE_CONNECTED "CONNECTION_STATE_CONNECTED" state. The
   ...
   with the server.
   - If the SDK cannot re-log in the Meta RTM system, it stays in the \ref
   meta::rtm::CONNECTION_STATE_RECONNECTING "CONNECTION_STATE_RECONNECTING"
  ...
  /**
   5: The SDK gives up logging in the Meta RTM system, mainly because another
   instance has logged in the Meta RTM system with the same user ID.

   You must call the \ref meta::rtm::IRtmService::logout "logout" method to
   leave this state before calling the \ref meta::rtm::IRtmService::login
   "login" method again.
   */
...
enum CONNECTION_CHANGE_REASON {
  ...
  /**
   4: The SDK fails to log in the Meta RTM system within six seconds and gives
   up.
   */
  CONNECTION_CHANGE_REASON_LOGIN_TIMEOUT = 4,

  /**
   5: The connection between the SDK and the Meta RTM system is interrupted. The
   system defines an interruption when the SDK loses connection with the Meta
   RTM system for network reasons and cannot recover in four seconds.
   */
  CONNECTION_CHANGE_REASON_INTERRUPTED = 5,

  /**
   6: The user has called the \ref meta::rtm::IRtmService::logout "logout"
   method to log out of the Meta RTM system.
   */
  CONNECTION_CHANGE_REASON_LOGOUT = 6,

  /**
   7: The SDK login to the Meta RTM system is banned by Meta.
   */
  CONNECTION_CHANGE_REASON_BANNED_BY_SERVER = 7,

  /**
   8: Another user is logging in the Meta RTM system with the same User ID.
   */
...
enum PEER_MESSAGE_ERR_CODE {
  ...
  /**
   ...
   meta::rtm::CONNECTION_STATE_ABORTED "CONNECTION_STATE_ABORTED" or \ref
   meta::rtm::CONNECTION_STATE_RECONNECTING "CONNECTION_STATE_RECONNECTING"
   state.
   */
  ...
  /**
   102: The sender does not call the \ref meta::rtm::IRtmService::login "login"
   method, or the method call of \ref meta::rtm::IRtmService::login "login" does
...
enum LEAVE_CHANNEL_ERR {
  ...
  /**
   102: The user does not call the \ref meta::rtm::IRtmService::login "login"
   method, or the method call of \ref meta::rtm::IRtmService::login "login" does
   not succeed before calling the \ref meta::rtm::IChannel::leave "leave"
   method.
   */
...
enum CHANNEL_MESSAGE_ERR_CODE {
  ...
  /**
   ...
   \ref meta::rtm::CONNECTION_STATE_ABORTED "CONNECTION_STATE_ABORTED" or \ref
   meta::rtm::CONNECTION_STATE_RECONNECTING "CONNECTION_STATE_RECONNECTING"
   state.
   */
...
enum PEER_ONLINE_STATE {
  ...
  /**
   0: The peer is online (the SDK has logged in the Meta RTM system).
   */
  ...
  /**
   2: The peer is offline (the SDK has not logged in the Meta RTM system, or it
...
enum ATTRIBUTE_OPERATION_ERR {
  ...
  /**
   ...
   - For \ref meta::rtm::IRtmService::setLocalUserAttributes
   "setLocalUserAttributes", \ref
   meta::rtm::IRtmService::addOrUpdateLocalUserAttributes
   "addOrUpdateLocalUserAttributes", \ref
   meta::rtm::IRtmService::deleteLocalUserAttributesByKeys
   "deleteLocalUserAttributesByKeys" and \ref
   meta::rtm::IRtmService::clearLocalUserAttributes "clearLocalUserAttributes"
   taken together: the call frequency limit is 10 queries every five seconds.
   - For \ref meta::rtm::IRtmService::getUserAttributes "getUserAttributes" and
   \ref meta::rtm::IRtmService::getUserAttributesByKeys
   "getUserAttributesByKeys" taken together, the call frequency limit is 40
   queries every five seconds.
   - For \ref meta::rtm::IRtmService::setChannelAttributes
   "setChannelAttributes", \ref
   meta::rtm::IRtmService::addOrUpdateChannelAttributes
   "addOrUpdateChannelAttributes", \ref
   meta::rtm::IRtmService::deleteChannelAttributesByKeys
   "deleteChannelAttributesByKeys" and \ref
   meta::rtm::IRtmService::clearChannelAttributes "clearChannelAttributes" taken
   together: the call frequency limit is 10 queries every five seconds.
   - For \ref meta::rtm::IRtmService::getChannelAttributes
   "getChannelAttributes" and \ref
   meta::rtm::IRtmService::getChannelAttributesByKeys
...
enum DOWNLOAD_MEDIA_ERR_CODE {
  ...
  /**
   ...
   - The user is in the \ref meta::rtm::CONNECTION_STATE_ABORTED
   "CONNECTION_STATE_ABORTED" state.
...
enum UPLOAD_MEDIA_ERR_CODE {
  ...
  /**
   ...
   - The user in the \ref meta::rtm::CONNECTION_STATE_ABORTED
   "CONNECTION_STATE_ABORTED" state.
...
class IRtmChannelAttribute {
 ...
 public:
  ...
  /**
   Release all resources used by the \ref meta::rtm::IRtmChannelAttribute
...
class IMessage {
 ...
 public:
  ...
  /**
   ...
   meta::rtm::SendMessageOptions::enableOfflineMessaging
  ...
  /**
   Releases all resources used by the \ref meta::rtm::IMessage "IMessage"
   instance.

   @note For the message receiver: please access and save the content of the
   IMessage instance when receiving the \ref
   meta::rtm::IChannelEventHandler::onMessageReceived "onMessageReceived" or the
   \ref meta::rtm::IRtmServiceEventHandler::onMessageReceivedFromPeer
...
class IImageMessage : public IMessage {
 public:
  ...
  /**
   ...
   meta::rtm::IImageMessage::getWidth() "getWidth" directly to get the width of
   the image.
  ...
  /**
   ...
   meta::rtm::IImageMessage::setWidth() "setWidth" overrides the width
   calculated by the SDK.
  ...
  /**
   ...
   - If the uploaded image is in JPG, JPEG, BMP, or PNG format, the SDK
   automatically calculates the width and height of the image. You can call \ref
   meta::rtm::IImageMessage::getHeight() "getHeight" directly to get the height
   of the image.
  ...
  /**
   ...
   meta::rtm::IImageMessage::setHeight() "setHeight" overrides the height
   calculated by the SDK.
...
class IChannelMember {
 ...
 public:
  ...
  /**
   Releases all resources used by the \ref meta::rtm::IChannelMember
...
struct PeerOnlineStatus {
  ...
  /**
   ...
   meta::rtm::PeerOnlineStatus::onlineState "onlineState" instead.

   The online status of the peer.

   - true: The user is online (the user has logged in the Meta RTM system).
   - false: The user is offline (the user has logged out of the Meta RTM system,
  ...
  /**
   ...
   (\ref meta::rtm::IRtmService::queryPeersOnlineStatus
   "queryPeersOnlineStatus"). See also: \ref
   meta::rtm::IRtmServiceEventHandler::onQueryPeersOnlineStatusResult
   "onQueryPeersOnlineStatusResult".
   - The server may return the `unreachable` state, if you <i>subscribe to</i>
   the online status of specified peer(s)
   (\ref meta::rtm::IRtmService::subscribePeersOnlineStatus
   "subscribePeersOnlineStatus"). See also: \ref
   meta::rtm::IRtmServiceEventHandler::onPeersOnlineStatusChanged
...
/**
 @brief Callbacks for the Meta RTM channel methods.
 */
class IChannelEventHandler {
 public:
  ...
  /**
   ...
   When the local user calls the \ref meta::rtm::IChannel::join "join" method
   and successfully joins the channel:
   - The SDK triggers this callback;
   - All remote users in the channel receive the \ref
   meta::rtm::IChannelEventHandler::onMemberJoined "onMemberJoined" callback.
   */
  ...
  /**
   ...
   The local user receives this callback when the \ref meta::rtm::IChannel::join
  ...
  /**
   Returns the result of the \ref meta::rtm::IChannel::leave "leave" method
   call.
  ...
  /**
   ...
   @param message The received channel message. See \ref meta::rtm::IMessage
   "IMessage".
   */
  ...
  /**
   ...
   meta::rtm::IImageMessage "IImageMessage".
   */
  ...
  /**
   ...
   meta::rtm::IFileMessage "IFileMessage".
   */
  ...
  /**
   Returns the result of the \ref meta::rtm::IChannel::sendMessage "sendMessage"
   method call.
  ...
  /**
   ...
   When a remote user calls the \ref meta::rtm::IChannel::join "join" method and
   receives the \ref meta::rtm::IChannelEventHandler::onJoinSuccess
  ...
  /**
   ...
   When a remote member in the channel calls the \ref meta::rtm::IChannel::leave
   "leave" method and receives the the \ref
   meta::rtm::IChannelEventHandler::onLeave "onLeave (LEAVE_CHANNEL_ERR_OK)"
  ...
  /**
   Returns the result of the \ref meta::rtm::IChannel::getMembers "getMembers"
   method call.
  ...
  /**
   ...
   meta::rtm::ChannelAttributeOptions::enableNotificationToChannelMembers
...
/**
 @brief Meta RTM channel methods.
 */
class IChannel {
 protected:
  virtual ~IChannel() {}
 ...
 public:
  ...
  /**
   ...
   meta::rtm::JOIN_CHANNEL_ERR "JOIN_CHANNEL_ERR_FAILURE" error code.

   - If this method call succeeds:
      - The local user receives the \ref
   meta::rtm::IChannelEventHandler::onJoinSuccess "onJoinSuccess" callback.
      - All remote users receive the \ref
   meta::rtm::IChannelEventHandler::onMemberJoined "onMemberJoined" callback.
   - If this method call fails, the local user receives the \ref
   meta::rtm::IChannelEventHandler::onJoinFailure "onJoinFailure" callback. See
  ...
  */
  ...
  /**
   ...
   - If this method call succeeds:
      - The local user receives the \ref
   meta::rtm::IChannelEventHandler::onLeave "onLeave" callback with the
   LEAVE_CHANNEL_ERR_OK state.
      - All remote users receive the \ref
   meta::rtm::IChannelEventHandler::onMemberLeft "onMemberLeft" callback.
   - If this method call fails, the local user receives the \ref
   meta::rtm::IChannelEventHandler::onLeave "onLeave" callback with an error
   code. See \ref meta::rtm::LEAVE_CHANNEL_ERR "LEAVE_CHANNEL_ERR" for the error
   codes.
   @return
   - 0: Success.
  ...
  /**
   ...
   Meta does not recommend using this method to send a channel message. Use \ref
   meta::rtm::IChannel::sendMessage(const IMessage *message, const
   SendMessageOptions &options) "sendMessage" instead.

   If this method call succeeds:
   - The \ref meta::rtm::IChannelEventHandler::onSendMessageResult
   "onSendMessageResult" callback returns the result.
   - All remote users in the channel receive the \ref
   meta::rtm::IChannelEventHandler::onMessageReceived "onMessageReceived"
   callback.

   @note You can send messages, including peer-to-peer and channel messages, at
   a maximum speed of 60 queries per second.

   @param message The message to be sent. See \ref meta::rtm::IMessage
   "IMessage".
   @return
   - 0: Success.
  ...
  /**
   ...
   meta::rtm::SendMessageOptions "SendMessageOptions".
   @return
   - 0: Success.
   - &ne;0: Failure. See #CHANNEL_MESSAGE_ERR_CODE for the error codes.
   */
  ...
  /**
   ...
   The \ref meta::rtm::IChannelEventHandler::onGetMembers "onGetMembers"
  ...
  /**
   Releases all resources used by the \ref meta::rtm::IChannel "IChannel"
   instance.
   */
  virtual void release() = 0;
};
...
class IRtmServiceEventHandler {
 public:
  ...
  /**
   Occurs when a user logs in the Meta RTM system.

   The local user receives this callback when the \ref
   meta::rtm::IRtmService::login "login" method call succeeds.
   */
  virtual void onLoginSuccess() {}

  /**
   Occurs when a user fails to log in the Meta RTM system.

   The local user receives this callback when the \ref
   meta::rtm::IRtmService::login "login" method call fails. See \ref
   meta::rtm::LOGIN_ERR_CODE "LOGIN_ERR_CODE" for the error codes.
   */
  virtual void onLoginFailure(LOGIN_ERR_CODE errorCode) {
  }

  /**
   Reports the result of the \ref meta::rtm::IRtmService::renewToken
  ...
  /**
   ...
   call the \ref meta::rtm::IRtmService::renewToken "renewToken" method to pass
   the new Token on to the server.
   */
  virtual void onTokenExpired() {}

  /**
   Occurs when a user logs out of the Meta RTM system.

   The local user receives this callback when the SDK calls the \ref
   meta::rtm::IRtmService::logout "logout" method. See \ref
   meta::rtm::LOGOUT_ERR_CODE "LOGOUT_ERR_CODE" for the error codes.
   */
  virtual void onLogout(LOGOUT_ERR_CODE errorCode) {
  }

  /**
   Occurs when the connection state changes between the SDK and the Meta RTM
   system.
  ...
  /**
   Reports the result of the \ref meta::rtm::IRtmService::sendMessageToPeer
  ...
  /**
   ...
   meta::rtm::MediaOperationProgress "MediaOperationProgress".
   */
  ...
  /**
   ...
   meta::rtm::IRtmService::createFileMessageByUploading
   "createFileMessageByUploading" method call.

   @param requestId The unique ID of the upload request.
   @param fileMessage An \ref meta::rtm::IFileMessage "IFileMessage" instance.
  ...
  /**
   Reports the result of the \ref
   meta::rtm::IRtmService::createImageMessageByUploading
   "createImageMessageByUploading" method call.

   @param requestId The unique ID of the upload request.
   @param imageMessage An \ref meta::rtm::IImageMessage "IImageMessage"
   instance.
   @param code Error codes. See #UPLOAD_MEDIA_ERR_CODE.
   */
  ...
  /**
   Reports the result of the \ref meta::rtm::IRtmService::downloadMediaToFile
  ...
  /**
   Reports the result of the \ref meta::rtm::IRtmService::downloadMediaToMemory
  ...
  /**
   Reports the result of the \ref meta::rtm::IRtmService::cancelMediaDownload
   "cancelMediaDownload" or \ref meta::rtm::IRtmService::cancelMediaUpload
  ...
  /**
   Reports the result of the \ref meta::rtm::IRtmService::queryPeersOnlineStatus
  ...
  /**
   ...
   meta::rtm::IRtmService::subscribePeersOnlineStatus
   "subscribePeersOnlineStatus" or \ref
   meta::rtm::IRtmService::unsubscribePeersOnlineStatus
  ...
  /**
   Returns the result of the \ref
   meta::rtm::IRtmService::queryPeersBySubscriptionOption
  ...
  /**
   Reports the result of the \ref meta::rtm::IRtmService::setLocalUserAttributes
  ...
  /**
   Reports the result of the \ref meta::rtm::IRtmService::getUserAttributes
   "getUserAttributes" or \ref meta::rtm::IRtmService::getUserAttributesByKeys
  ...
  /**
   Reports the result of the \ref meta::rtm::IRtmService::setChannelAttributes
  ...
  /**
   Reports the result of the \ref meta::rtm::IRtmService::clearChannelAttributes
  ...
  /**
   Reports the result of the \ref meta::rtm::IRtmService::getChannelAttributes
  ...
  /**
   Reports the result of the \ref meta::rtm::IRtmService::getChannelMemberCount
...
class IRtmService {
 ...
 public:
  /**
   ...
   @param appId The App ID issued by Meta to you. Apply for a new App ID from
   Meta if it is missing from your kit.
   @param eventHandler An IRtmServiceEventHandler object that invokes callbacks
   to be passed to the application on Meta RTM SDK runtime events.
   @return
   - 0: Success.
   - < 0: Failure.
   */
  ...
  /**
   Releases all resources used by the \ref meta::rtm::IRtmService "IRtmService"
   instance.
   */
  ...
  /**
   ...
   - If this method call fails, the local user receives the \ref
   meta::rtm::IRtmServiceEventHandler::onLoginFailure "onLoginFailure" callback.
   See \ref meta::rtm::LOGIN_ERR_CODE "LOGIN_ERR_CODE" for the error codes.
   ...
   the \ref meta::rtm::IRtmServiceEventHandler::onLoginSuccess "onLoginSuccess"
   callback), can you call the key RTM methods except:
        - \ref meta::rtm::IRtmService::createChannel "createChannel"
        - \ref meta::rtm::IRtmService::createMessage "createMessage"
        - \ref meta::rtm::IMessage::setText "setText"
        - \ref meta::rtm::IRtmService::getRtmCallManager "getRtmCallManager"
        - \ref meta::rtm::IRtmCallManager::createLocalCallInvitation
   "createLocalCallInvitation"
        - \ref meta::rtm::IRtmService::createChannelAttribute
   "createChannelAttribute"

   @param token Token used to log in the Meta RTM system and used when dynamic
   authentication is enabled. Set @p token as @p nil in the integration and test
   stages.
   @param userId The user ID of the user logging in Meta's RTM system. The
  ...
  /**
   ...
   The local user receives the \ref meta::rtm::IRtmServiceEventHandler::onLogout
   "onLogout" callback. See \ref meta::rtm::LOGOUT_ERR_CODE "LOGIN_ERR_CODE" for
   the error codes.
  ...
  /**
   ...
   meta::rtm::IRtmServiceEventHandler::onTokenExpired "onTokenExpired" callback,
   and the \ref meta::rtm::IRtmServiceEventHandler::onRenewTokenResult
  ...
  /**
   ...
   \ref meta::rtm::IRtmService::sendMessageToPeer(const char *peerId, const
   ...
   message, see \ref meta::rtm::IMessage "IMessage".
   @return
   - 0: Success.
  ...
  /**
   Downloads a file or image from the Meta server to the local memory by media
   ID.

   The SDK returns the result of this method call by the \ref
   meta::rtm::IRtmServiceEventHandler::onMediaDownloadToFileResult
   ...
   the \ref meta::rtm::IRtmServiceEventHandler::onMediaDownloadToFileResult
   "onMediaDownloadToMemoryResult" callback.
  ...
  /**
   Downloads a file or image from the Meta server to a specified local directory
   by media ID.
  ...
  /**
   ...
   meta::rtm::IRtmServiceEventHandler::onMediaCancelResult "onMediaCancelResult"
   callback.
  ...
  /**
   ...
   META_RTM_ENDCALL_PREFIX_\<channelId\>_\<your additional information\>, then
   this method is compatible with the endCall method of the legacy Meta
   ...
   - The \ref meta::rtm::IRtmServiceEventHandler::onSendMessageResult
   ...
   meta::rtm::IRtmServiceEventHandler::onMessageReceivedFromPeer
  ...
  /**
   ...
   Agore recommends calling the \ref meta::rtm::IChannel::release "release"
   ...
   @return
   - An \ref meta::rtm::IChannel "IChannel" object: Success.
  ...
  /**
   Gets an \ref meta::rtm::IRtmCallManager "IRtmCallManager" object.

   Each \ref meta::rtm::IRtmService "IRtmService" object corresponds to a unique
   \ref meta::rtm::IRtmCallManager "IRtmCallManager" object. That said, the \ref
   meta::rtm::IRtmCallManager "IRtmCallManager" object is \ref
   meta::rtm::IRtmService "IRtmService"-specific.

   @note When you do no use \ref meta::rtm::IRtmCallManager "IRtmCallManager",
   call the \ref meta::rtm::IRtmCallManager::release "release" method to release
   all of its resources.

   @param eventHandler An \ref meta::rtm::IRtmCallEventHandler
   "IRtmCallEventHandler" object.
   @return An \ref meta::rtm::IRtmCallManager "IRtmCallManager" object.
   */
  virtual IRtmCallManager* getRtmCallManager(
    IRtmCallEventHandler* eventHandler) = 0;

  /**
   Creates an empty text \ref meta::rtm::IMessage "IMessage" instance.

   @note
   - An \ref meta::rtm::IMessage "IMessage" instance can be used either for a
   channel message or for a peer-to-peer message.
   - When you no longer need an \ref meta::rtm::IMessage "IMessage" instance,
   please call the \ref meta::rtm::IMessage::release "release" method to release
   all resources that it is using.
   - You can set the content of the text message at a later point using the \ref
   meta::rtm::IMessage::setText "setText" method, but please ensure that the
   size of the text message does not exceed 32 KB.

   @return An empty text \ref meta::rtm::IMessage "IMessage" instance.
   */
  virtual IMessage* createMessage() = 0;

  /**
   Creates a text \ref meta::rtm::IMessage "IMessage" instance.
   ...
   @return A text \ref meta::rtm::IMessage "IMessage" instance.
   */
  virtual IMessage* createMessage(const char* message) = 0;

  /**
   Creates a raw \ref meta::rtm::IMessage "IMessage" instance.
   ...
   using the \ref meta::rtm::IMessage::setText "setText" method, but please
   ...
   @return A raw \ref meta::rtm::IMessage "IMessage" instance.
   */
  virtual IMessage* createMessage(const uint8_t* rawData, int length) = 0;

  /**
   Creates a raw \ref meta::rtm::IMessage "IMessage" instance and sets its
   description.
   ...
   raw message at a later point using the \ref meta::rtm::IMessage::setText
   ...
   @return A raw \ref meta::rtm::IMessage "IMessage" instance with a brief text
   description.
   */
  ...
  /**
   Creates an \ref meta::rtm::IFileMessage "IFileMessage" instance by media ID.

   - If you have at hand the media ID of a file on the Meta server, you can call
   this method to create an \ref meta::rtm::IFileMessage "IFileMessage"
   instance.
   - If you do not have a media ID, then you must call \ref
   meta::rtm::IRtmService::createFileMessageByUploading
   "createFileMessageByUploading" to get a corresponding \ref
   meta::rtm::IFileMessage "IFileMessage" instance by uploading a file to the
   Meta RTM server.

   @param mediaId The media ID of an uploaded file on the Meta server.
   @return An \ref meta::rtm::IFileMessage "IFileMessage" instance.
   */
  virtual IFileMessage* createFileMessageByMediaId(const char* mediaId) = 0;

  /**
   Creates an \ref meta::rtm::IImageMessage "IImageMessage" instance by media
   ID.

   - If you have at hand the media ID of an image on the Meta server, you can
   call this method to create an \ref meta::rtm::IImageMessage "IImageMessage"
   instance.
   - If you do not have a media ID, then you must call \ref
   meta::rtm::IRtmService::createImageMessageByUploading
   "createImageMessageByUploading" to get a corresponding \ref
   meta::rtm::IImageMessage "IImageMessage" instance by uploading an image to
   the Meta RTM server.

   @param mediaId The media ID of an uploaded image on the Meta server.
   @return An \ref meta::rtm::IImageMessage "IImageMessage" instance.
   */
  virtual IImageMessage* createImageMessageByMediaId(const char* mediaId) = 0;

  /**
   Gets an \ref meta::rtm::IFileMessage "IFileMessage" instance by uploading a
   file to the Meta server.

   The SDK returns the result with the \ref
   meta::rtm::IRtmServiceEventHandler::onFileMediaUploadResult callback. If
   success, this callback returns a corresponding \ref meta::rtm::IFileMessage
   "IFileMessage" instance.

   @note
   - If you have at hand the media ID of a file on the Meta server, you can call
   \ref meta::rtm::IRtmService::createFileMessageByMediaId
   "createFileMessageByMediaId" to create an \ref meta::rtm::IFileMessage
   "IFileMessage" instance.
   - To cancel an ongoing file upload task, call \ref
   meta::rtm::IRtmService::cancelMediaUpload "cancelMediaUpload".
  ...
  /**
   Gets an \ref meta::rtm::IImageMessage "IImageMessage" instance by uploading
   an image to the Meta server.

   The SDK returns the result by the \ref
   meta::rtm::IRtmServiceEventHandler::onImageMediaUploadResult callback. If
   success, this callback returns a corresponding \ref meta::rtm::IImageMessage
   ...
   meta::rtm::IImageMessage::getWidth "getWidth" and \ref
   meta::rtm::IImageMessage::getHeight "getHeight" to get the calculated width
   and height.
   - Otherwise, you need to call \ref meta::rtm::IImageMessage::setWidth
   "setWidth" and \ref meta::rtm::IImageMessage::setHeight "setHeight" to set
   the width and height of the uploaded image by yourself.

   @note
   - If you have at hand the media ID of an image on the Meta server, you can
   call \ref meta::rtm::IRtmService::createImageMessageByMediaId
   "createImageMessageByMediaId" to create an \ref meta::rtm::IImageMessage
  ...
  /**
   Creates an \ref meta::rtm::IRtmChannelAttribute "IRtmChannelAttribute"
   instance.

   @return An \ref meta::rtm::IRtmChannelAttribute "IRtmChannelAttribute"
   instance.
   */
  ...
  /**
   ...
   @note The JSON options are not public by default. Meta is working on making
   commonly used JSON options public in a standard way. Contact
   [support@meta.io](mailto:support@meta.io) for more information.
  ...
  /**
   ...
   The SDK returns the result by the \ref
   meta::rtm::IRtmServiceEventHandler::onSubscriptionRequestResult
   ...
   @note
   - When you log out of the Meta RTM system, all the status that you subscribe
  ...
  /**
   ...
   The SDK returns the result by the \ref
   meta::rtm::IRtmServiceEventHandler::onQueryPeersBySubscriptionOptionResult
  ...
  /**
   ...
   The SDK returns the result by the \ref
   meta::rtm::IRtmServiceEventHandler::onSetLocalUserAttributesResult
   "onSetLocalUserAttributesResult" callback.

   @note For \ref meta::rtm::IRtmService::setLocalUserAttributes
   "setLocalUserAttributes", \ref
   meta::rtm::IRtmService::addOrUpdateLocalUserAttributes
   "addOrUpdateLocalUserAttributes", \ref
   meta::rtm::IRtmService::deleteLocalUserAttributesByKeys
  ...
  /**
   ...
   The SDK returns the result by the \ref
   meta::rtm::IRtmServiceEventHandler::onAddOrUpdateLocalUserAttributesResult
  ...
  /**
   ...
   The SDK returns the result by the \ref
   meta::rtm::IRtmServiceEventHandler::onDeleteLocalUserAttributesResult
  ...
  /**
   ...
   The SDK returns the result by the \ref
   meta::rtm::IRtmServiceEventHandler::onClearLocalUserAttributesResult
  ...
  /**
   ...
   The SDK returns the result by the \ref
   meta::rtm::IRtmServiceEventHandler::onGetUserAttributesResult
   "onGetUserAttributesResult" callback.

   @note For \ref meta::rtm::IRtmService::getUserAttributes "getUserAttributes"
   and \ref meta::rtm::IRtmService::getUserAttributesByKeys
   "getUserAttributesByKeys" taken together, the call frequency limit is 40
   queries every five seconds.
  ...
  /**
   ...
   The SDK returns the result by the \ref
   meta::rtm::IRtmServiceEventHandler::onSetChannelAttributesResult
   ...
   - If more than one user can update the channel attributes, then Meta
   recommends calling \ref meta::rtm::IRtmService::getChannelAttributes
   ...
   meta::rtm::IRtmChannelAttribute "IRtmChannelAttribute".
   @param numberOfAttributes The total number of the channel attributes.
  ...
  /**
   ...
   The SDK returns the result by the \ref
   meta::rtm::IRtmServiceEventHandler::onAddOrUpdateChannelAttributesResult
  ...
  /**
   ...
   The SDK returns the result by the \ref
   meta::rtm::IRtmServiceEventHandler::onDeleteChannelAttributesResult
  ...
  /**
   ...
   The SDK returns the result by the \ref
   meta::rtm::IRtmServiceEventHandler::onClearChannelAttributesResult
  ...
  /**
   ...
   The SDK returns the result by the \ref
   meta::rtm::IRtmServiceEventHandler::onGetChannelAttributesResult
  ...
  /**
   ...
   The SDK returns the result by the \ref
   meta::rtm::IRtmServiceEventHandler::onGetChannelMemberCountResult
  ...
  /**
   ...
   meta::rtm::IRtmService::initialize "initialize" method to initialize an \ref
   meta::rtm::IRtmService "IRtmService" instance, otherwise the output log may
   be incomplete.
   - For the Linux C++ platform, <i>metartm.log</i> is in the current working
   directory.
...
/**
Creates an \ref meta::rtm::IRtmService "IRtmService" instance.

@note When you no longer need an \ref meta::rtm::IRtmService "IRtmService"
instance, ensure that you call the \ref meta::rtm::IRtmService::release
"release" method to release all resources that it uses.

@return An \ref meta::rtm::IRtmService "IRtmService" instance.
*/
META_CPP_API IRtmService* createRtmService();
...
@return The version of the Meta RTM SDK.
*/
META_CPP_API const char* getRtmSdkVersion();
