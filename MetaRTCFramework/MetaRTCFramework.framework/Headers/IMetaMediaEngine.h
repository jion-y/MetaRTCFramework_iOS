#ifndef META_MEDIA_ENGINE_H
#define META_MEDIA_ENGINE_H
#include <stdint.h>
...
class IAudioFrameObserver {
  ...
  */
  ...
  /** Determines whether to receive audio data from multiple channels.
   ...
   In the multi-channel scenario, Meta recommends setting the return value as true.
...
class IVideoFrameObserver {
 ...
 public:
  ...
  /** Determines whether to receive video data from multiple channels.
   ...
   send the video frame. onRenderVideoFrame will not be triggered. In the multi-channel scenario, Meta recommends setting the return value as true.
...
struct ExternalVideoRenerContext {
   ...
   */
  void* view;
  /** Video display mode: \ref meta::rtc::RENDER_MODE_TYPE "RENDER_MODE_TYPE" */
  int renderMode;
...
class IMediaEngine {
 public:
  ...
  /** **DEPRECATED** Use \ref meta::media::IMediaEngine::pushAudioFrame(IAudioFrameObserver::AudioFrame* frame) "pushAudioFrame(IAudioFrameObserver::AudioFrame* frame)" instead.
   ...
   * \ref meta::rtc::IRtcEngine::setExternalAudioSink 
   ...
   * 
   * @note
   * - Once you call the \ref meta::media::IMediaEngine::pullAudioFrame 
   ...
   * \ref meta::media::IMediaEngine::pullAudioFrame "pullAudioFrame" method is as 
   * follows:
  ...
  virtual int pullAudioFrame(IAudioFrameObserver::AudioFrame* frame) = 0;
    ...
    */
    ...
    /** Pushes the video frame using the \ref ExternalVideoFrame "ExternalVideoFrame" and passes the video frame to the Meta SDK.
