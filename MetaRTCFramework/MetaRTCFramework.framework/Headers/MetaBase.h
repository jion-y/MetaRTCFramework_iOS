...
enum INTERFACE_ID_TYPE {
  META_IID_AUDIO_DEVICE_MANAGER = 1,
  META_IID_VIDEO_DEVICE_MANAGER = 2,
  META_IID_RTC_ENGINE_PARAMETER = 3,
  META_IID_MEDIA_ENGINE = 4,
  META_IID_SIGNALING_ENGINE = 8,
};
...
enum WARN_CODE_TYPE {
  ...
  /** **DEPRECATED** 105: The server rejects the request to look up the channel.
   ...
   \ref meta::rtc::IRtcEngineEventHandler::onConnectionStateChanged
  ...
  */
   ...
   * the audio playback device, which may cause echoes problem. Meta recommends
...
enum ERROR_CODE_TYPE {
   ...
   * the channel, for example, \ref meta::rtc::IRtcEngine::joinChannel
   * "joinChannel".
   */
  ...
  /** 18: The request to leave the channel is rejected.
   ...
   meta::rtc::IRtcEngine::leaveChannel "leaveChannel" to leave the channel. In
   this case, stop calling \ref meta::rtc::IRtcEngine::leaveChannel
   "leaveChannel".
  ...
  /** **DEPRECATED** 109: Deprecated as of v2.4.1. Use
   ...
   seconds elapsed since 1/1/1970. The user can use the Token to access the Meta
   service within 24 hours after the Token is generated. If the user does not
   access the Meta service after 24 hours, this Token is no longer valid.
   - Call Expiration Timestamp expired: The timestamp is the exact time when a
   user can no longer use the Meta service (for example, when a user is forced
  ...
  /** **DEPRECATED** 110: Deprecated as of v2.4.1. Use
   ...
   \ref meta::rtc::IRtcEngine::joinChannel "joinChannel" method.
   */
  ERR_INVALID_TOKEN = 110,
  /** 111: The internet connection is interrupted. This applies to the Meta Web
   * SDK only.
   */
  ERR_CONNECTION_INTERRUPTED = 111,  // only used in web sdk
  /** 112: The internet connection is lost. This applies to the Meta Web SDK
   * only.
   */
  ERR_CONNECTION_LOST = 112,  // only used in web sdk
  /** 113: The user is not in the channel when calling the \ref
   * meta::rtc::IRtcEngine::sendStreamMessage "sendStreamMessage" or \ref
   * meta::rtc::IRtcEngine::getUserInfoByUserAccount "getUserInfoByUserAccount"
   * method.
   */
  ERR_NOT_IN_CHANNEL = 113,
  /** 114: The size of the sent data is over 1024 bytes when the user calls the
   * \ref meta::rtc::IRtcEngine::sendStreamMessage "sendStreamMessage" method.
   */
  ERR_SIZE_TOO_LARGE = 114,
  /** 115: The bitrate of the sent data exceeds the limit of 6 Kbps when the
   * user calls the \ref meta::rtc::IRtcEngine::sendStreamMessage
   * "sendStreamMessage" method.
   */
  ERR_BITRATE_LIMIT = 115,
  /** 116: Too many data streams (over 5 streams) are created when the user
   * calls the \ref meta::rtc::IRtcEngine::createDataStream "createDataStream"
   * method.
   */
   ...
   * meta::rtc::IRtcEngine::addPublishStreamUrl "addPublishStreamUrl" method
   ...
   * by calling the \ref meta::rtc::IRtcEngine::removePublishStreamUrl
   * "removePublishStreamUrl" and \ref
   * meta::rtc::IRtcEngine::addPublishStreamUrl "addPublishStreamUrl" methods.
   */
  ...
  /** 154: An error occurs in Meta's streaming server. Call the
